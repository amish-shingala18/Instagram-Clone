...
import com.example.instagram.databinding.FragmentPublicBinding
...
class PublicFragment : Fragment() {
    override fun onCreateView(
        ...
        val binding:FragmentPublicBinding = FragmentPublicBinding.bind(view)
        ...
        binding.rvPublic.adapter = chatRecyclerAdapter
        return binding.root
    }
}